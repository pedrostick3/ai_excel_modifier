...
from modules.ai_manual_implementation.services.azure_ai_service import AzureAiService
from modules.ai_manual_implementation.services.openai_ai_service import OpenAiAiService
from modules.ai_manual_implementation.agents.excel_categorizer_agent.excel_categorizer_agent import ExcelCategorizerAgent
from modules.ai_manual_implementation.agents.excel_header_finder_agent.excel_header_finder_agent import ExcelHeaderFinderAgent
from modules.ai_manual_implementation.agents.excel_pre_header_modifier_agent.excel_pre_header_modifier_agent import ExcelPreHeaderModifierAgent
from modules.ai_manual_implementation.agents.excel_content_modifier_agent.excel_content_modifier_agent import ExcelContentModifierAgent
from modules.ai_manual_implementation.agents.excel_generic_content_modifier_agent.excel_generic_content_modifier_agent import ExcelGenericContentModifierAgent
from modules.ai_manual_implementation.function_calls_agent.excel_sum_columns_agent.excel_sum_columns_agent import ExcelSumColumnsAgent
from modules.ai_manual_implementation.file_search_agent.file_search_agent.file_search_agent import FileSearchAgent
from modules.ai_manual_implementation.code_interpreter_agent.code_interpreter_agent.code_interpreter_agent import CodeInterpreterAgent
from modules.ai_manual_implementation.fine_tuning_agents.excel_generic_agent.excel_generic_fine_tuning_agent import ExcelGenericFinetuningAgent
...
class AiManualImplementation:
    """
    This class is a manual implementation of the AI process for PoC3.
    """
    
    @staticmethod
    def run(
        input_files: list[str],
        custom_ai_service_base_url: str,
        custom_ai_service_key: str,
        custom_ai_service_model: str,
        finetuning_base_model: str,
        ...
        Args:
            ...
            custom_ai_service_base_url (str): Custom AI Service base URL.
            custom_ai_service_key (str): Custom AI Service key.
            custom_ai_service_model (str): Custom AI Service model.
            finetuning_base_model (str): Fine-tuning base model.
