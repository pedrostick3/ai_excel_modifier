...
from modules.ai_manual_implementation.fine_tuning_agents.excel_generic_agent.prompts_validators import excel_categorizer_and_header_finder_agent_prompts_validators
import logging
...
class FinetuningFileGenerator:
    ...
    TRAINING_FILE_PATH = "./modules/ai_manual_implementation/fine_tuning_agents/utils/fine_tuning_file_generator/generated_files/excel_fine_tuning_data.jsonl"
    VALIDATION_FILE_PATH = "./modules/ai_manual_implementation/fine_tuning_agents/utils/fine_tuning_file_generator/generated_files/excel_fine_tuning_data_validation.jsonl"
