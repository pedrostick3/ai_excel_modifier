...
import shutil
import time
from modules.ai_manual_implementation.fine_tuning_agents.utils.fine_tuning_file_generator.fine_tuning_file_generator import FinetuningFileGenerator
...
from modules.ai_manual_implementation.enums.ai_fine_tuning_job_status import AiFineTuningJobStatus
import modules.excel.constants.excel_constants as excel_constants
import constants.configs as configs
from modules.ai_manual_implementation.fine_tuning_agents.excel_generic_agent.prompts import excel_categorizer_agent_prompts
from modules.ai_manual_implementation.fine_tuning_agents.excel_generic_agent.prompts import excel_header_finder_agent_prompts
...
from modules.ai_manual_implementation.fine_tuning_agents.excel_generic_agent.prompts import excel_content_modifier_with_code_agent_prompts
...
from modules.ai_manual_implementation.function_calls_agent.enums.functions_to_call import FunctionsToCall
...
```""",
            ai_analytics_file_name=ai_analytics_file_name,
            ai_analytics_agent_name="ExcelGenericFinetuningAgent (ExcelCategorizerAgent)",
        )
    ...
    def get_excel_header(self, excel_file_path: str, ai_analytics_file_name: str = None) -> str:
        ...
        excel_header_finder_agent_response = self.ask_ai(
            ...
            ai_analytics_agent_name="ExcelGenericFinetuningAgent (ExcelHeaderFinderAgent)",
        )
...
excel_header_row_index = {excel_header_row_index}""",
                ai_analytics_file_name=ai_analytics_file_name,
                ai_analytics_agent_name="ExcelGenericFinetuningAgent (ExcelContentModifierWithCodeAgent)",
            )
        except Exception as e:
