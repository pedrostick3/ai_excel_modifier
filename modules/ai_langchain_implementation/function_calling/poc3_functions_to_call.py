...
class PoC3FunctionsToCall:
    ...
    def modify_excel_content_for_execution_category(
        ...
        df = PoC3FunctionsToCall._remove_empty_rows_and_columns(df, excel_header_row_index)

        # Step 1: Move 'IsSuccessful' column to column A
        is_successful_column_name = PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(df, 'IsSuccessful')
        ...
        average_run_time_seconds_column_name = PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(df, 'AverageRunTimeSeconds')
        ...
        run_time_seconds_column_name = PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(df, 'RunTimeSeconds')
        ...
        for col in date_columns:
            column_name = PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(df, col)
            if column_name:
        ...
        task_workload_column_name = PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(df, 'TaskWorkload')
    ...
    def modify_excel_content_for_test_execution_category(
        ...
        try:
            ...
            expected_columns_order_checked = [PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(df, column, excel_header_row_index) for column in expected_columns_order]
        ...
        try:
            ...
            if excel_header_row_index is not None and table_last_row is not None and table_last_row >= excel_header_row_index:
                ...
                columns_to_sum_checked = [PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(aux_dataFrame, column) for column in columns_to_sum]
        ...
        try:
            ...
            if excel_header_row_index is not None and excel_header_row_index < len(df):
                ...
                task_workload_column_name = PoC3FunctionsToCall._check_column_name_and_make_case_insensitive_if_needed(df, 'TaskWorkload', excel_header_row_index)
